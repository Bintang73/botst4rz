...
//
const BotName = 'RIZKI 🎃'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com'; // Nama Instagramlu cok
const whatsapplu = '089xx'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/FsAlnxqz6y2BhCQi5ayCLG'; // OFFICIAL GRUP 1
const grupch2 = 'https://chat.whatsapp.com/KLW3UlFfeaH36Ucm5zRfCz'; // OFFICIAL GRUP 2
//
const
{
   WAConnection,
