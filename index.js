...
//
const BotName = '꧁T̆̈s̆̈ă̈q̆̈ĭ̈f̆̈ Bᴏᴛ꧂ 🤖'; // Nama Bot Whatsapp
...
const grupch1 = 'https://chat.whatsapp.com/FZSHEjX4feOK73r4L1jHvR'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/FZSHEjX4feOK73r4L1jHvR'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Muhammad_Tsaqif_Fathurrizqi`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Muhammad_Tsaqif_Fathurrizqi`)
})
