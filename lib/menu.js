exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, facebooklu, whatsapplu, kapanbotaktif, grupch1, grupch2) => {
	return `🔰 -----[ *MENU ${BotName}* ]----- 🔰
